...
export class MerkleTree {
  ...
  constructor(public n_levels: number, public prefix: string, public hasher: Hasher, public storage = new JsStorage()) {
    this.zero_values = [];
  ...
  async path(index: number) {
    class PathTraverser {
      ...
      path_index: number[];
      constructor(public prefix: string, public storage: JsStorage, public zero_values: string[]) {
        this.path_elements = [];
        this.path_index = [];
      }
